...
def run_experiment(
    ...
    print(f"\n{BOLD}{'='*60}{RST}")
    print(f"{BOLD}  Reactive Controller — Statistical Experiment{RST}")
...
def _parse():
    ...
    p.add_argument("controller",
                   help="Path to the ROS controller Python script")
    ...
    p.add_argument("--odom-topic",     default="/rmf_owl/odom",
                   help="ROS topic for Odometry messages")
    p.add_argument("--imu-topic",      default="/rmf_owl/imu",
